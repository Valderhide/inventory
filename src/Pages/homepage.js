  ...
  return (
    <div className="descript">
      ...
      <p>
        ...
        direction than my previous Javascript Snake Game.
      </p>
      <h2>How to use the App</h2>
      <p>
        The bulk of the work is done with the "Add Item" button found at the top
        of the table, below the Navigation bar. Click the "Add Item" button and
        a new menu will open with all the options you can assign the item being
        made.
      </p>
      <p>
        ...
        category reveals a dropdown with subcategories, which further reveals a
        list of properties.
      </p>
      <p>
        ...
        description and store location are filled in manually. Once done, click
        save changes and the item will be saved and displayed in the table.
      </p>
      <p>
      ...
      <p>
        Click the link bellow or at the top of the page to access the Inventory
        system itself
      </p>
      <Link to="/inventory">
